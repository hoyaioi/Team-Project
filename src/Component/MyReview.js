...
function MyReview() {
  ...
  const handlerDidReview = () => {
    ...
    axios
      .get(`http://localhost:8080/mypage/myreview/did/${memIdx}`)
      .then((response) => {
      ...
      <div id="main">
        <div className="myreview_wrap">
          ...
          <div className="myreview_notice">
            <p>
              1. 리뷰는 "주문 현황" 메뉴에서 "구매확정" 후 작성이 가능하며, 작성
              후 수정은 가능하지만 삭제는 불가합니다.
            </p>
            <p>2. 구매한 제품과 무관한 내용은 임의 삭제될 수 있습니다!</p>
            <p>
              3. 욕설, 비방글, 성적인 수치심을 유발하는 내용 등 다른 사람이
              보기에 기분나쁠 수 있는 글은 작성하지 말아주세요.
            </p>
            <p>4. 주소, 주민번호, 연락처 등 개인정보 기입은 절대 안 돼요!</p>
          </div>
          {open ? (
            <ReviewWrite
              setOpen={setOpen}
                ...
                <div className="myreview_review_wrap">
                  <div className="myreview_menu_wrap">
                    ...
                    <button
                      className={
                        btnActive[1]
                          ? "myreview_did_btn_active"
                          : "myreview_did_btn"
                      }
                      onClick={handlerDidReview}
                    >
                      작성한 리뷰
                    </button>
                  </div>
                  ...
                  <div className="myreview_list_wrap">
                    {btnActive[0] ? (
                      <div className="myreview_able_wrap">
                        {datas.length === 0 ? (
                          <div className="myreview_nondata">
                            구매확정한 주문 건이 없습니다.
                          </div>
                        ) : (
                          <ul>
