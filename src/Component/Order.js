...
function Order() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/member/${memEmail}`)
      .then((response) => {
  ...
  const handlerClickSubmit = (e) => {
    ...
    if (checkType === "new") {
      ...
      axios.all(
        [
          axios.post("http://localhost:8080/changeAddr", memInfo),
      ...
      axios
        .post("http://localhost:8080/insertOrder", orderInfo)
        .then((response) => {
          console.log(response);
        })
        .catch((error) => {
                  ...
                  <div className="order_price_sum">
                    <div className="order_sum_cont">
                      <div className="order_sum_list">
                        <dl>
                          <dt>
                            총 <strong></strong> {item.length}개의 상품금액{" "}
                          </dt>
                          <dd>
                        ...
                        <span>
                          <img
                            src="/images/order_price_plus.png"
                            alt="더하기"
                          />
                        </span>
                        <dl>
                        ...
                        <dl class="price_total">
                          <dt>합계</dt>
                          <dd>
                            <strong>{totalPrice + 2500}</strong>원
                          </dd>
                        </dl>
                      </div>
                    </div>
                            ...
                            <td class="member_address">
                              <div class="address_postcode">
                                <input
                                  ...
                                  readonly="readonly"
                                  value={
                                    checkType === "same" ? data.memPostNum : ""
                                  }
                                />
                                <input type="hidden" name="receiverZipcode" />
                                <span
                                  id="receiverZipcodeText"
                                  class="old_post_code"
                                ></span>
                                <button
                                  type="button"
